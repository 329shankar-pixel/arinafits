@component('shop::emails.layout')
    ...
    <div style="display: flex;margin-bottom: 95px">
        <a
            ...
            style="padding: 16px 45px;justify-content: center;align-items: center;gap: 10px;border-radius: 2px;background: #A63E58;color: #FFFFFF;text-decoration: none;text-transform: uppercase;font-weight: 700;"
        >
