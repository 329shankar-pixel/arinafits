            ...
            <div class="relative">
                ...
                >
                    ...
                    >
                        <a
                            :href="category.slug"
                            class="h-[110px] w-[110px] rounded-full bg-arina-light ring-1 ring-arina-border transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_14px_30px_-12px_rgba(166,62,88,0.5)] hover:ring-2 hover:ring-arina max-md:h-20 max-md:w-20 max-sm:h-[60px] max-sm:w-[60px]"
                ...
                <span
                    class="icon-arrow-left-stylish absolute -left-10 top-9 flex h-[50px] w-[50px] cursor-pointer items-center justify-center rounded-full border border-zinc-200 bg-white text-2xl shadow-md transition hover:border-navyBlue hover:bg-navyBlue hover:text-white max-lg:-left-7 max-md:hidden"
                    role="button"
                ...
                <span
                    class="icon-arrow-right-stylish absolute -right-6 top-9 flex h-[50px] w-[50px] cursor-pointer items-center justify-center rounded-full border border-zinc-200 bg-white text-2xl shadow-md transition hover:border-navyBlue hover:bg-navyBlue hover:text-white max-lg:-right-7 max-md:hidden"
                    role="button"
