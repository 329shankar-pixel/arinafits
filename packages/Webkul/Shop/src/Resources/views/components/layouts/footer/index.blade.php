...
>
    <div class="flex justify-between gap-x-6 gap-y-8 p-[60px] max-1060:flex-col-reverse max-md:gap-5 max-md:p-8 max-sm:px-4 max-sm:py-5">
        ...
        <x-shop::accordion
            :is-active="false"
            class="hidden !w-full rounded-xl !border-2 !border-arina-border max-1060:block max-sm:rounded-lg"
        >
            <x-slot:header class="rounded-t-lg bg-arina-light font-medium max-md:p-2.5 max-sm:px-3 max-sm:py-2 max-sm:text-sm">
                    ...
                    >
                        <div class="relative w-full">
                            <x-shop::form.control-group.control
                                type="email"
                                class="block w-[420px] max-w-full rounded-xl border-2 border-arina-border bg-white px-5 py-4 text-base max-1060:w-full max-md:p-3.5 max-sm:mb-0 max-sm:rounded-lg max-sm:border-2 max-sm:p-2 max-sm:text-sm"
                                name="email"
                            ...
                            <button
                                type="submit"
                                class="absolute top-1.5 flex w-max items-center rounded-xl bg-navyBlue px-7 py-2.5 font-medium text-white hover:opacity-90 ltr:right-2 rtl:left-2 max-md:top-1 max-md:px-5 max-md:text-xs max-sm:mt-0 max-sm:rounded-lg max-sm:px-4 max-sm:py-2"
                            >
    ...
    <div class="flex justify-between bg-arina-light px-[60px] py-3.5 max-md:justify-center max-sm:px-5">
